...
Select lfcotr,sum(limpgs)Monto, eneadm from libdebito.drconbeP where  lfcotr = '20201105' and lesttr = 'A' and lcretr = '00' and substr(lidtra,1,1) = 'T' 
...
where a.costat='0' and b.afsern like ('%P%')
*******************************************************************************************************************
*******************************************************************************************************************
...
*******************************************************************************************************************
/*COMERCIOS CON TRX EN POS SEGUN CHIP*/
*******************************************************************************************************************
select a.cocomer,b.afcodi,b.afsern from gxbdbps.comaeaf a
inner join gxbdbps.coafmaf b on a.cocomer=b.afcomer
where a.costat='0' and b.afsern like ('%P%')
...
select a.cocomer,b.afcodi,b.afsern from gxbdbps.comaeaf a inner join gxbdbps.coafmaf b on a.cocomer=b.afcomer where a.costat='0' and b.afsern like ('%P%')
...
select OPCOMER AS COMERCIO, CORUCN AS RUC,  ZONADESC AS ZONA, OPSTATUS AS ESTADOTRX,  RPRENAME AS REPRESENT , 
CODENO AS DENOMINACION, OPCODTRN AS TRX,  OPFECOM AS FECHA, OPHOTRN AS HORA, OPMONTO AS IMPORTE,  OPNOREF AS REFERENCIA, OPCELU AS CELULAR, SUBSTR(LCTADE,8,9) AS REFTigo
 from gxopera.opmovi
 INNER JOIN GXBDBPS.COMAEAF A ON (OPCOMER = COCOMER)
 inner join gxbdbps.cozonaf d
on a.zonacodi = d.zonacodi
