SELECT PGFECRE,PGCODMV,Sum(PGIMPOR) IMPORTE, pgtipo,pgidusr,pgcomer
--SELECT *  
from gxopera.opago1phis
where  PGCOMER='6500055'
...
group by pgtipo
select * from gxopera.opago0ph where pgfcre='2021-05-31'
select sum(pgimpo),pgcmov  from gxopera.opago0ph where pgfcre='2021-05-31'
group by pgcmov
...
SELECT * FROM gxopera.opago1phis
 WHERE pgfecre = '20210601' and pgcomer='4500123'
...
--HISTÓRICO
--TOTAL
SELECT * FROM gxopera.COPAEN2PHS where bnfcomer='4500123' and bnffecre='20210601' 
...
**************************************************************************************
Trabajo:   ENVIO_BNF  03:45 hs     CONTABILIDAD BNF julio  1507  paula 1641
**************************************************************************************
113643
SELECT count(*) FROM LIBDEBITO.BDBNFENV0P where substr(lidtra,1,1)='T' and eneadm='002'
56694

SELECT  * FROM LIBDEBITO.BDBNFENV0P  where lfcotr='20211213' 147839
select * from LIBDEBITO.BDBNFENV0H where lfcotr='20211213' 295678
...
SELECT substr(lidtra,1,4) Cajero,count(*) cantidad,sum(limpgs),lesttr estado
 FROM LIBDEBITO.BDBNFENV0P WHERE LFCOTR='20211213' and lcretr='00' and lesttr='A' and ENEADM ='002'
...
SELECT substr(lidtra,1,4) Cajero,count(*) cantidad,sum(limpgs),lesttr estado
 FROM LIBDEBITO.BDBNFENV0P WHERE LFCOTR='20211213' and lcretr='00' and lesttr='A' and ENEADM ='002' and substr(lidtra,1,1) in ('T')
group by substr(lidtra,1,4),lesttr
...
SELECT substr(lidtra,1,4) Cajero,count(*) cantidad,sum(limpgs),lesttr estado
 FROM LIBDEBITO.BDBNFENV0H WHERE LFCOTR='20211213' and lcretr='00' and lesttr='A' and ENEADM ='002' and substr(lidtra,1,1) in ('T')
group by substr(lidtra,1,4),lesttr
order by substr(lidtra,1,4) asc

delete LIBDEBITO.BDBNFENV0H WHERE LFCOTR='20211213' 295678
select count(*) from  LIBDEBITO.BDBNFENV0H WHERE LFCOTR='20211213' 295678
...
select * from gxopera.opmovi where opmonto='1000' and opcodtrn='000054'
select * from gxopera.opliqui where opfecliq='20210629'
