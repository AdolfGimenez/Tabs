...
SELECT * FROM CHECKOUT_PLATFORM.public.CYBERSOURCE_MERCHANT_INFO CMI WHERE CMI.CS_ID='dinelco_link_002798500001';

SELECT *
FROM CHECKOUT_PLATFORM.PUBLIC.MERCHANTS M
         INNER JOIN PUBLIC.CYBERSOURCE_MERCHANT_INFO CMI ON M.CS_MERCHANT_ID = CMI.ID;

SELECT * FROM PAGOS_DIGITALES_DB.public.COMERCIOS C WHERE C.CYBERSOURCE_MERCHANT_ID IN ('dinelco_link_002798500001');
