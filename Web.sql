...
WHERE ECB.COD_CLIENTE_BEPSA IN ('12633'); --AND SBD.COD_SUCURSAL_BEPSA_DB2 NOT IN ('4','16','15','11','10','9','8');
...
WHERE ECB.COD_CLIENTE_BEPSA IN ('12633')
...
--inner join personas_fisicas p1 on p1.persona_id = p.id
         ...
         INNER JOIN PUBLIC.EMPRESAS_CLIENTES_BEPSA ECB ON ECB.ID = EC.EMPRESA_CLIENTE_BEPSA_ID
WHERE P1.RUC_NORMALIZADO IN ('80060586-1');
SELECT * FROM public.PERSONAS_FISICAS PF WHERE PF.APELLIDO LIKE '%VUYK%';
...
SELECT * FROM CHECKOUT_PLATFORM.public.CYBERSOURCE_MERCHANT_INFO CMI WHERE CMI.CS_ID='dinelco_002904300001';
...
FROM PAGOS_DIGITALES_DB.PUBLIC.COMERCIOS C WHERE C.CYBERSOURCE_MERCHANT_ID IN ('dinelco_002904300001');
...
SELECT * from public.COMERCIOS C WHERE C.ID_INTERNO='1200444';
...
-----""" fin v1
---VER LLAVESv2 CORRECTAMENTE CARGADAS EN LA V2
...
---nuevo v2 cyb merchand checkout platform checkout
SELECT m.*
...
WHERE M.CS_INFO_ID IN
    (SELECT CMI.ID FROM CHECKOUT_PLATFORM.CHECKOUT.CYBERSOURCE_MERCHANT_INFO CMI
     WHERE CMI.CYBERSOURCE_ID IN ('dinelco_bm_002327100008'));
...
SELECT * FROM public.USUARIOS U WHERE U.ID='ec458655-cfb6-4354-9c5b-0573fc6ac22b';
--U.CORREO='rolando.benitez@documenta.com.py' OR U.CORREO_NO_VERIFICADO='pamelacareaga37@gmail.com';
--se borra de correo y se cambia en noverificado --rolando.benitez@documenta.com.py
SELECT * FROM public.REFRESH_TOKENS RT WHERE RT.USUARIO_ID='ec458655-cfb6-4354-9c5b-0573fc6ac22b';
--pamelacareaga37@gmail.com
--aca también en pocodi
SELECT * FROM public.CORREOS_PRINCIPALES_USUARIOS CPU WHERE CPU.USUARIO_ID='ec458655-cfb6-4354-9c5b-0573fc6ac22b';
--ver qaui
SELECT * FROM eqwedi_auth_db.public.SEGURIDADES S WHERE USUARIO_ID='ec458655-cfb6-4354-9c5b-0573fc6ac22b';
...
select * from usuarios where id in ('47bfa3c4-56b8-41e3-a46f-f3d3b9994cb0', '36148e1b-60ad-41b0-978d-bd0f581c2243');

--INSERT INTO public.usuarios (id, correo, activo, eliminado, bloqueado, ultimo_log, nombre, apellido, tipo_documento_id, nro_documento, funcionario, ldap, insertado_el, modificado_el, cambio_activo_el, cambio_activo_por, cambio_eliminado_el, cambio_eliminado_por, correo_no_verificado, motivo_eliminacion, insertado_por, modificado_por) VALUES ('47bfa3c4-56b8-41e3-a46f-f3d3b9994cb0', null, true, false, false, '2025-07-18 14:35:21.746000', 'Arturo Fidel', 'Duarte Oviedo', 1, '712517', false, false, '2025-07-18 11:35:21.749593', '2025-07-18 11:35:21.749593', null, null, null, null, 'arturodu43@hotmail.com', null, null, null);
--INSERT INTO public.usuarios (id, correo, activo, eliminado, bloqueado, ultimo_log, nombre, apellido, tipo_documento_id, nro_documento, funcionario, ldap, insertado_el, modificado_el, cambio_activo_el, cambio_activo_por, cambio_eliminado_el, cambio_eliminado_por, correo_no_verificado, motivo_eliminacion, insertado_por, modificado_por) VALUES ('36148e1b-60ad-41b0-978d-bd0f581c2243', 'arturodu43@hotmail.com', true, false, false, '2025-07-29 18:25:12.292000', 'Arturo Fidel', 'Duarte Oviedo', 1, '712517', false, false, '2025-07-18 11:35:26.289049', '2025-07-29 15:25:12.292806', null, null, null, null, 'arturodu43@hotmail.com', null, null, null);