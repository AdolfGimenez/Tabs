...
--AUTH_DB
SELECT * FROM EQWEDI_AUTH_DB.PUBLIC.USUARIOS U WHERE U.NRO_DOCUMENTO='5107555';
...
--POCODI_DB
SELECT * FROM public.PERSONAS_FISICAS PF where /*upper(apellido) = 'BENITEZ';*/ PF.NRO_DOCUMENTO='1848486';
SELECT * FROM public.USUARIOS U WHERE U.PERSONA_FISICA_ID IN (16115);
...
SELECT * FROM public.SUCURSALES_BEPSA_DB2 S WHERE S.CLIENTE_BEPSA_ID=2742;
SELECT * FROM public.SUCURSALES S WHERE S.COMERCIO_ID=2815;
...
SELECT * FROM CHECKOUT_PLATFORM.public.CYBERSOURCE_MERCHANT_INFO CMI WHERE CMI.CS_ID='dinelco_002872300001';
...
FROM PAGOS_DIGITALES_DB.PUBLIC.COMERCIOS C WHERE C.CYBERSOURCE_MERCHANT_ID IN ('dinelco_002872300001');
