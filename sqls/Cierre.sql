...
SELECT * FROM GXBDBPS.TPCIE WHERE PCFCH='20230221';
SELECT * FROM GXBDBPS.TSPCIE WHERE PCFCH='20230221' AND SUBEST='N';-- and proccod='CIEMAIN'
SELECT * FROM GXBDBPS.TCIERAF WHERE ENEMISO='002' AND AFFECIE='20230221' AND AFAFINI='001' AND AFFECIE BETWEEN '20230121' AND '20230121';
SELECT * FROM GXBDBPS.TMENSAF WHERE ENEMISO='319' AND AFFECIE='20210121';
SELECT * FROM GXBDBPS.GUSERAF WHERE USIDUSR='U99OVELAR';
SELECT * FROM GXBDBPS.TLOGSAF WHERE LSFECHA='20230121' AND LSPROG LIKE '%tcie001 AsignaNroControl%';

SELECT * FROM GXBDBPS.TLOGSAF WHERE LSFECHA='20230121' AND LSTIPRO='CIER';
...
--
SELECT * FROM DATOSLIB.MAESTRO021
----------------------------