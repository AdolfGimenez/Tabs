...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2024-10-28-17.00.00.000000', '2024-10-28-21.40.00.000000')) A
WHERE FROM_JOB_NAME='QRWTSRVR' AND fROM_USER = 'QUSER'; --AND FROM_JOB_NAME='VISAADQJ';
FROM_JOB LIKE '099259/QUSER/QRWTSRVR'; --AND MESSAGE_ID='CPF1164';
...
SELECT FROM_USER,
    ...
    ORDER BY PEAK_TEMPORARY_STORAGE DESC LIMIT 10;

SELECT * FROM  DWHLIB.CTRLCIEPOS;

SELECT * FROM "DWHLIB"."VWPRORUTEO" LIMIT 10
