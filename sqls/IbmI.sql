...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2025-04-04-07.41.30.000000', '2025-04-04-07.43.00.000000')) A
...
WHERE OBJOWNER='U99GERMANV' OBJTEXT LIKE '%CREDIVIL%';-- OBJNAME LIKE 'R274%';
