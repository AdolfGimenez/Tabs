...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2025-08-02-00.00.00.000000', '2025-08-02-13.50.00.000000')) A
WHERE --FROM_JOB_NAME='QRWTSRVR' AND
fROM_USER = 'U99ZARATE'; --AND FROM_JOB_NAME='VISAADQJ';
...
SELECT DISTINCT SECURE_VERSION, SECURE_PROPERTIES FROM TABLE(
  SYSTOOLS.AUDIT_JOURNAL_SK(STARTING_TIMESTAMP => CURRENT TIMESTAMP - 2 HOURS))
WHERE ENTRY_TYPE <> 'S';
