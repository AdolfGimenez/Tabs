...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2025-03-19-14.15.00.000000', '2025-03-19-15.00.00.000000')) A
WHERE --FROM_JOB_NAME='QRWTSRVR'-- AND fROM_USER = 'QUSER'; --AND FROM_JOB_NAME='VISAADQJ';
FROM_JOB LIKE '243549/U99JROJAS/JROJASJOBD'; --AND MESSAGE_ID='CPF1164';
...
FROM TABLE (QSYS2.OBJECT_STATISTICS('LIBDEBITO','*PGM')) X
WHERE OBJTEXT LIKE '%CREDIVIL%';-- OBJNAME LIKE 'R274%';
