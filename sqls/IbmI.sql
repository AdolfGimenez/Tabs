--brelac
SELECT DISTINCT  WHPNAM,WHTEXT FROM WRKADOLFO.BRELACPROD WHERE WHFNAM LIKE '%TBDAUD%';
--------------------------------------------ver log as
...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2025-01-13-01.40.00.000000', '2025-01-13-02.10.00.000000')) A
WHERE --FROM_JOB_NAME='QRWTSRVR'-- AND fROM_USER = 'QUSER'; --AND FROM_JOB_NAME='VISAADQJ';
FROM_JOB LIKE '518392/U99ADOLFO/BK_AUD'; --AND MESSAGE_ID='CPF1164';
...
FROM TABLE (QSYS2.OBJECT_STATISTICS('MASTERCARD','*FILE')) X
WHERE OBJNAME LIKE 'R274%';
OBJNAME  IN ('JAVRG042  ', 'CNXRPGCINT', 'CNXRPGACRE', 'CNXRPGAPPN', 'JAVRG024  ', 'JAVRG025NW', 'CNXRPGAPP ', 'CNXRPGCAUT', 'JAVRGANDE ', 'JAVRG005  ', 'JAVRG006  ', 'JAVRG012  ', 'JAVRG052  ', 'VSARG100  ', 'JAVRG028  ', 'JAVRG600  ', 'JAVRG600NW', 'CNXRPGTIGO', 'CNXRPGRAUT', 'CNXRPGACRR', 'CNXRGMSGNT', 'CNXRPGBBVA', 'CNXDEB167 ', 'CNXDEB115 ', 'CNXDEB165 ', 'CNXDEB166 ', 'CNXRPGBUSD', 'JAVRG042A ', 'JAVRG042P ', 'JAVRG042PA', 'CNXDEB170 ', 'CNXDEB172 ', 'CNXDEB174 ', 'CNXRPGWALL', 'CNXDEB177 ', 'CNXDEB171 ', 'CNXDEB169 ', 'CNXDEB180 ')
...
SELECT * FROM QSYS2.SCHEMATA_S SS;

SELECT CREATE_TIME
FROM SYSCAT.SCHEMATA
WHERE SCHEMANAME = 'NOMBRE_DEL_ESQUEMA';
SELECT * FROM QSYS2.SCHEMATA S



SELECT *
FROM TABLE(SYSTOOLS.SPOOLED_FILE_DATA(
JOB_NAME => '512094/SIMON/QPADEV0001',
          SPOOLED_FILE_NAME => 'QPRINT',  SPOOLED_FILE_NUMBER => 2));

SELECT * FROM TABLE(QSYS2.SPOOLED_FILE_INFO ( USER_NAME => 'U99HERNAN',
  STARTING_TIMESTAMP => CURRENT_TIMESTAMP - 2 DAYS,
  ENDING_TIMESTAMP => CURRENT_TIMESTAMP - 1 DAYS,
  STATUS => '*READY *HELD',
  JOB_NAME => '*',
  OUTPUT_QUEUE => '*ALL',
  USER_DATA => '*ALL',
