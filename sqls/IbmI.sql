...
SELECT * FROM TABLE(QSYS2.HISTORY_LOG_INFO('2025-06-17-01.00.00.000000', '2025-06-17-01.10.00.000000')) A
WHERE --FROM_JOB_NAME='QRWTSRVR' AND
fROM_USER = 'USRBIELK'; --AND FROM_JOB_NAME='VISAADQJ';
...
FROM TABLE (QSYS2.OBJECT_STATISTICS('LOYALTY','*ALL')) X
