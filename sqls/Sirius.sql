...
INNER JOIN SIFEN.TIMBRAD    O T ON D.IDEMPRESA=T.IDEMPRESA AND D.IDDE=T.IDDE
WHERE T.NRODELDOCUMENTO IN (249003, 249056, 248996, 249004, 248990, 249002, 248991, 249000, 248995, 275723, 275726, 275725, 275733, 275740, 275749, 275748, 249005, 249001, 248989, 249007, 249040, 249039, 249044, 249059, 249036, 275722, 275759, 248898, 248993, 248999, 275715, 275719, 275717, 275716, 275720, 275721, 275728, 275731, 275732, 275736, 275734, 275738, 275742, 275750, 275745, 275752, 275754, 248998, 248997, 248988, 248994, 248992, 248986, 249006, 248985, 248987, 249041, 249037, 249038, 249042, 249043, 249045, 249046, 249048, 249047, 249049, 249050, 249051, 249053, 249052, 249054, 249055, 249057, 249058, 249068, 275710, 275708, 275709, 275711, 275713, 275712, 275714, 275718, 275724, 275727, 275729, 275735, 275739, 275737, 275741, 275743, 275744, 275751, 275755, 275747, 275746, 275753, 275758)
AND T.IDCAJA=13;

SELECT D.* FROM SIFEN.DOCUMENTOELECTRONICO D WHERE idde IN (917820);
...
SELECT * FROM sirius.sifen.TIPOCONDICIONOPERACION T WHERE;
...
SELECT * FROM sirius.sifen.DOCUMENTOELECTRONICO D WHERE D.IDDE=985754;
