...
SELECT 'SBMJOB CMD(CALL PGM(LIBDEBITO/NCLPR0055) PARM(''' || '0000' || OPIDLIQ || ''')) JOB(CLER_BNF) USER(BEPSAUSR)'
FROM GXOPERA.OPLIQUi  WHERE OPNROREF IN ('500229203894','500229203867','500229204081','500229203903','500229203996','500229204118','500229204273','500229204351',
...
addlible gxweb *last , edtlibl
--Call para AS
SBMJOB CMD(CALL PGM(LIBDEBITO/NCLPR0066) PARM('000025010213704983')) JOB(CLER_BBVA) USER(BEPSAUSR)
SELECT 'SBMJOB CMD(CALL PGM(LIBDEBITO/NCLPR0066) PARM(''' || '0000' || OPIDLIQ || ''')) JOB(CLER_BBVA) USER(BEPSAUSR)'
FROM GXOPERA.OPLIQUi
WHERE OPNROREF IN (514391381547, 513588067565, 513588070528, 513588079051, 513588093445, 513588093867, 513588094009, 513588095449, 513588107733, 513588112468, 513588114759, 513588117373, 513588117462, 513588128458, 513588128585, 513588131068, 513588133044, 513588136022, 513588138470, 513588139883, 513588142987, 513588143239, 513588154782, 513688172527, 513688173983, 513688174616, 513688181660, 513688184743, 513688191361, 513688191557, 513688193745, 513688199047, 513688200600, 513688204583);
------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------#REINTENTO PAGO A COMERCIOS EN LINEA CON CUENTA EN CONTINENTAL#
--Ingresar a as400 e ingresar el comando
addlible gxweb *last, edtlibl
--Call para AS
SBMJOB CMD(CALL PGM(LIBDEBITO/NCLR001) PARM('000025010913751516')) JOB(CLER_CONTI) USER(BEPSAUSR)
--Call Auxtiliars
...
FROM GXOPERA.OPLIQUi
WHERE OPNROREF IN (500229178253, 501734784390, 505551900679, 506758373242, 506958821639, 506958821626, 511377577331, 514390408053);
------------------------------------------------------------------------------------------------------------------------------------------
