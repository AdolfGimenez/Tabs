...
FROM GXFINDTA.TCLTSB
WHERE DATE(TSBFEGE) BETWEEN '2025-03-30' AND '2025-03-31'
--AND TSBBADE = 1020
...
AND SUBSTR(O.OPCAMPOA, 1, 6)=703002 AND O.OPCODBCO NOT IN ('74', '146','189');
...
SELECT
    ...
    O.OPCODBCO BANCO, O.OPIMPORB IMPORTE_BRUTO, O.OPIMPOR  NETO, O.OPNRCTCR COMPROBANTE, O.OPSTAT STATUS,
    O.OPMENSAJ MENSAJE
