...
WHERE DATE(TSBFEGE) BETWEEN '2025-07-24' AND '2025-07-25'
  AND TSBBADE = 1020
  AND TSBTPOP = 1-- <> '04'
AND TSBESTA IN ('EN', 'IB')
--  AND TSBCOME IN ('000')
GROUP BY DATE(TSBFEGE), TSBTPOP, TSBBADE, TSBBACR, TSBESTA, TSBCOME, TSBDEME
ORDER BY 1;

SELECT DATE(TSBFEGE), TSBDEOP,/* TSBCOCO, TSBDENE,*/ TSBESTA, TSBCOME RETORNO, TSBDEME RESPUESTA, COUNT(*) CANTIDAD, SUM(TSBIMPO) MONTO
FROM GXFINDTA.TCLTSB
WHERE DATE(TSBFEGE) BETWEEN '2025-07-24' AND '2025-07-28'
AND TSBTPOP = 1
--AND TSBBADE = 1020
--AND TSBCOME IN ('000', '999')
AND TSBESTA IN ('EN', 'IB','PE') --AND TSBTPOP=01
GROUP BY DATE(TSBFEGE), /*TSBCOCO, TSBDENE,*/ TSBDEOP, TSBESTA, TSBCOME, TSBDEME
ORDER BY 3;
SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBIDOP=18159957;
-------------------------------------------
...
SELECT * FROM gxfindta.tclmov
         WHERE sercodi = 'VTAMIN' AND MOVOPOR = '700405' AND movfpro BETWEEN '20250621' AND '20250720';

SELECT * FROM GXTRJDTA.TDGECO  T WHERE T.ENTCODENT='7004' AND T.ENSIDSERV='VTAMIN';

--Resumen de Liquidacion legacy
...
----tarjeta prepagas
SELECT * FROM gxfindta.tcltsb WHERE TSBBACR = '9000' AND date(TSBFEAC) = '2025-07-24';
SELECT mtnumta, mvnumct,cmcodig,MVTIPOT, mvferea, mvfepro, mvimpo2,mvnomco FROM GXBDBPS.TMOVIAF WHERE MTNUMTA ='6274311460198507';
SELECT mtnumta, mvnumct,cmcodig,MVTIPOT, mvferea, mvfepro, mvimpo2,mvnomco FROM GXBDBPS.TMOVIAF
WHERE  MVTIPOT = 'C' AND MVFEPRO = '20250724'
AND MTNUMTA in(SELECT TSBCTCR FROM gxfindta.tcltsb WHERE TSBBACR = '9000' AND date(TSBFEAC) = '2025-07-24');
---O MIRAR EN EL HISTORICO
SELECT * FROM GXBDBPS.THMOVAF T;
SELECT * FROM GXFINDTA.TCLTSB T WHERE TSBNREF IN ('252040010702267', '252040010704464', '252040010705006', '252040010705162', '252040010705625', '252040010705661', '252040010705682', '252040010705742', '252040010705852', '252040010706127', '252040010706154', '252040010706229', '252040010706335', '252040012300504', '252040012800153', '252040012800157', '252040014900304', '252040014900365', '252040014900420', '252040014900457', '252040016001285', '252040016001435', '252040016900977', '252040016901015', '252040016901064', '252040016901667', '252040038600953', '252040038604396', '252040038604420', '252040038604631', '252040038605006', '252040038605754', '252040038605878', '252040038605933', '252040038606099', '252040038606881', '252040038606929', '252040038606968', '252040038607001', '252040038607374', '252040038607397', '252040038607451', '252040010704928')