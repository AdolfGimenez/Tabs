...
WHERE MOVOPOR IN ('700405', '700105', '700605')
  AND MOVFCRE BETWEEN '20250521' AND '20250620'
...
SELECT * FROM JPTSAPI.KEYS_CYBERSOURCE_SHOPS where cybersource_shop_id = 'dinelco_link_002463500001';
...
select * from JPTSAPI.cybersource_merchant_routing where merchant_id IN ('000000002301505');
...
VALUES('000000000400132', now(), 'SERVITRAVEL');
--nombre = 'HEART WOOD' AND id_interno = '304256'

SELECT
    * FROM GXFINDTA.TCLMOV T WHERE T.MOVRRNBEP='518309181213';
SELECT * FROM LIBDEBITO.DRCONBEP D WHERE D.LERRNB='518309181213';
SELECT * FROM GXBDBPS.TSWAUT T WHERE T.AUTRRNBEP='51489344332';

SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF='251890074500223';
SELECT * FROM GXFINDTA.TCLTSD T WHERE T.TSBIDOP=17920838;
