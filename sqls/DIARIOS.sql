...
WHERE MOVOPOR IN ('700405', '700105', '700605')
  AND MOVFCRE BETWEEN '20241121' AND '20241220'
...
SELECT * FROM MARCAS.REGISTC46 r WHERE r.ARCHIVO='202432_TC45UPD.EPIN.TXT';
SELECT * FROM MARCAS.REGTC46G3;
SELECT * FROM MARCAS.REGTC46G5;
SELECT * FROM MARCAS.TC46G4TCR0;
SELECT * FROM MARCAS.TC46G4TCR1;
------------------
...
SELECT * FROM GXBDBPS.ATMCMSGDE;
SELECT * FROM GXBDBPS.ATMCMSGD;
...
SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF=433007712681; --T.TSBIDOP=14336323;



SELECT  * FROM WRKADOLFO.BRELACPROD b WHERE WHFNAM LIKE '%TCLCUP%';

SELECT WHLIB AS "Query lib",
      WHPNAM AS "Query",
      WHSNAM AS "File id",;
      WHLNAM AS "File lib",
      WHFNAM AS "File",
      WHRFNM AS "Rec format"
 FROM WRKADOLFO.BRELACPROD
WHERE WHOTYP = '*FILE'
ORDER BY WHLIB,WHPNAM,WHSNAM;

SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF='433007865755';
...
SELECT COUNT(*) FROM VISA.NRT_RRN_EX  E WHERE E.NRTLOGFECH >='2024-01-01';

SELECT DATA_QUEUE_LIBRARY, DATA_QUEUE_NAME , MAXIMUM_MESSAGE_LENGTH, CURRENT_MESSAGES
FROM QSYS2.DATA_QUEUE_INFO WHERE DATA_QUEUE_NAME LIKE '%ACFIREC%';


SELECT * FROM GXOPERA.OPLIQUI o WHERE OPNROREF in('422463238916',
'422463185269','422363034544','422363014915');

SELECT * FROM GXBDBPS.LGCOMENT L WHERE L.LGENTID = 1020   AND L.LGFECHOR BETWEEN '2024-03-01' AND '2024-10-31';

SELECT count(*) FROM HSTTRNPROC.TRNPRCDEB T;

SELECT --count(*)
*
FROM ATMCENTRE.FMTDEBATMC f ;
DELETE FROM ATMCENTRE.FMTDEBATMC
WHERE DEBUGTIMST <='2024-12-01-20.00.00.000000';
DELETE FROM GXFINDTA.TPRLOG  WHERE LODFIN <= '2024-11-01 00:00:00.000000';
--bus datos
SELECT CASE WHEN count(*) > 1000 THEN 'ALERT' ELSE 'OK' END AS bus_status2 , count(*) cant2
FROM GXFINDTA.TBDAUV;

SELECT * FROM GXFINDTA.TCLMOV T WHERE T.MOVRRNBEP IN ('436126122910','436126122187','436126122251');
SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF IN ('436126122910','436126122187','436126122251');

SELECT *
FROM GXFINDTA.TCLPFD
WHERE PFCIDPARM = 'SOCKET_CLEARING'
  AND PFDIDGRUP = 'CONTINENTAL';

INSERT INTO GXFINDTA.TCLPFD (PFCIDPARM, PFDIDGRUP, PFDSECU, PFDVALCHR1, PFDDSCCHR1, PFDVALCHR2, PFDDSCCHR2, PFDUSULSUP, PFDFECLSUP)
VALUES ('3DSECURE', 'CONTINENTAL', 3,
        'https://apibanking-gw.bancontinental.com.py/api-tarjeta-credito-pago/v1/api/tarjeta/pago/desafio/stepup',
        'STEPUP_URL', 'https://apibanking-gw.bancontinental.com.py/api-tarjeta-credito-pago/v1/api/tarjeta/pago/desafio/initiateaction', 'INITIATEACTION_URL', current_user, current_timestamp);


INSERT INTO GXFINDTA.TCLPFD (PFCIDPARM, PFDIDGRUP, PFDSECU, PFDVALCHR1, PFDDSCCHR1, PFDVALCHR2, PFDDSCCHR2, PFDUSULSUP, PFDFECLSUP)
VALUES ('3DSECURE', 'CONTINENTAL', 4,
        'https://apibanking-gw.bancontinental.com.py/api-tarjeta-credito-pago/v1/api/tarjeta/pago/desafio/validate',
        'VALIDATE_URL', '08354915e8d94921bc171c74a5a25191', 'API_KEY', current_user, current_timestamp);


Select COUNT(*) from gxbdbps.tswaut where auttrxfchc = '20241223';

SELECT * FROM GXFINDTA.TCMCLI T WHERE CLIDENCOM LIKE '%TRANSAGRO%';