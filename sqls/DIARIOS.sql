...
WHERE gT.MOVOPDE = 700405 AND GT.MOVFCRE BETWEEN '20250321' AND '20250420'
...
SELECT * FROM JPTSAPI.KEYS_CYBERSOURCE_SHOPS where cybersource_shop_id = 'dinelco_002872300001';
...
( 'dinelco_002872300001',  '05ac10e6-f66a-4da0-b353-9d8c5854e681',
 'Q1m3C21RPCr0yuSPBG1473xJiFTW+UXwc5Y0vMzD8uY=',
 now(), 'dinelco_checkout', NULL);

select * from JPTSAPI.cybersource_merchant_routing where merchant_id IN ('000000006901787');
nombre = 'BETSSON' AND id_interno = '4400047'
INSERT INTO JPTSAPI.cybersource_merchant_routing
(merchant_id, create_at, merchant_name)
VALUES('000000004400047', now(), 'BETSSON');
--nombre = 'FORTIS LINK DE PAGO' AND id_interno = '708473'

SELECT * FROM LIBDEBITO.DRCONBEP D WHERE D.LERRNB='573202483057';
SELECT * FROM LIBDEBITO.DRCONBEP D WHERE LFCOTR >='20250101' /*AND LNRTAR LIKE '604271%' */AND LHISDE='*REST'
AND LFORPAG='QR' AND LCODBC='CAB' AND D.LNRTAR LIKE '604266%';
SELECT * FROM GXBDBPS.TSWAUT WHERE AUTRRNBEP='573202483057';

SELECT * FROM ATMCENTRE.TBBINE0P T0P;
SELECT * FROM gxbdbps.coma3af WHERE cocomer = '6002138';
