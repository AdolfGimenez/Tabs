...
FROM GXFINDTA.TCLTSB
WHERE DATE(TSBFEGE) BETWEEN '2025-02-21' AND '2025-02-26'
  AND TSBBADE = 1020
  --AND TSBTPOP <> '04'
  AND TSBCOME IN ('000')
...
SELECT * FROM GXBDBPS.COMAEAF C2 WHERE C2.COCOMER=3800013;
SELECT * FROM  GXFINDTA.TCOCNA T WHERE T.COCOMER=3800013;

UPDATE GXFINDTA.TCLTSB SET TSBESTA = 'AC' WHERE TSBIDOP in (1155370,1250080);