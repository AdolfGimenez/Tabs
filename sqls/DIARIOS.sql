...
SELECT * FROM GXBDBPS.TMTARAF T WHERE MTNUMTA in ('6274311070218893','6274311550006321');
...
--ver
SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF IN
('175664850000146','175664850000147','175664850000149');

SELECT * FROM JPTSAPI.KEYS_CYBERSOURCE_SHOPS where cybersource_shop_id = 'dinelco_link_002894800001';
...
( 'dinelco_link_002894800001',  'df995b87-fc1e-4970-8d0e-392c812cfd5c',
 'PAJjnNNTb2tsDm/i52fvqVWsL2zCA36CzqhjOWIMFFE=',
 now(), 'dinelco_link', NULL);

select * from JPTSAPI.cybersource_merchant_routing where merchant_id IN ('000000000304256');
--nombre = 'VAPEHUS' AND id_interno = '1303812'

INSERT INTO JPTSAPI.cybersource_merchant_routing
(merchant_id, create_at, merchant_name)
VALUES('000000000304256', now(), 'HEART WOOD');
--nombre = 'HEART WOOD' AND id_interno = '304256'

SELECT * FROM GXFINDTA.TCLTSB T WHERE T.TSBNREF IN ('250660016001940','250690016001940');

SELECT * FROM LIBDEBITO.DRCONBEP D WHERE D.LERRNB='515195348514';
SELECT * FROM GXBDBPS.TSWAUT T WHERE T.AUTRRNBEP='515195348514';
SELECT * FROM GXFINDTA.TCLTPC T WHERE T.TPCRRNBEP='515195348514';
SELECT * FROM GXFINDTA.TCLCPC T;
