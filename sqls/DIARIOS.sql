...
--Tic
---REVERSA LLAMAR AL PCLR184
IN('485707954365','488508734455');

--BNF reintento

SELECT * FROM GXOPERA.OPLIQUI o WHERE OPNROREF in('426077510276','426077510427');

UPDATE GXOPERA.OPLIQUI o
SET OPNROCTC = '16003002267',OPTICTAC = 'K',OPNRCTCR = '16003002267',OPTCTACR = 'K'
WHERE OPNROREF in('426077510276','426077510427');

Con este programa
--REINTENTO BNF SBMJOB CMD(CALL PGM(LIBDEBITO/NCLPR0055) PARM('000021103105567223')) JOB(CLER_BNF) USER(QCOMUNICA)
