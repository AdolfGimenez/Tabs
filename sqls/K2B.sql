...
SELECT * FROM K2B_PREPROD.K2BPARAMETROS K2B;

SELECT * FROM k2b_prod.USUARIO U;
SELECT * FROM k2b_prod_gam.USER U;
#------kari
SELECT * FROM k2b_prod.MOVIMIENTOACTIVOFIJO M WHERE M.MovActivoFijoFechaValor='2025-03-13';
SELECT * FROM k2b_prod.MOVIMIENTOACTIVOFIJODETALLE M WHERE M.MOVACTIVOFIJOID IN (155676, 156205);
SELECT * FROM k2b_prod.INVENTARIOACTIVOFIJO I WHERE I.INVACTIVOFIJOID IN (155676, 156205);
...
SELECT M.MOVSTOCKFECHA, M.MOVSTOCKFECHAVALOR, M.* FROM k2b_prod.MOVIMIENTOSTOCK M WHERE M. 263897;