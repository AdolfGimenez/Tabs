...
WHERE T.MOVACTIVOFIJOID = 164187
  AND T.MOVACTIVOFIJODETID = 1
  AND T.MOVACTIVOFIJOINVID = 1
  AND T.MOVACTIVOFIJOITEMID = 1;
...
SELECT * FROM k2b_prod.INVENTARIOSTOCKITEM I WHERE I.INVITEMID=643244;
SELECT * FROM k2b_prod.INVENTARIOSTOCKPRODUCTO I;
SELECT * FROM k2b_prod.DEPOSITO D;


update acuerdo set acuerdoesqdistribucioncostoid = 13 where acuerdoid= 41;

update acuerdocumplimiento set acuerdocumplimientoimporte = 4090.91 where acuerdoid = 11 and acuerdocumplimientoid = 2;

update acuerdocumplimiento set acuerdocumplimientoimporte = 5454.55 where acuerdoid = 11 and acuerdocumplimientoid = 3;

update acuerdocumplimiento set acuerdocumplimientoimporte = 5454.55 where acuerdoid = 11 and acuerdocumplimientoid = 4;

update acuerdocumplimiento set acuerdocumplimientoimporte = 909.09 where acuerdoid = 11 and acuerdocumplimientoid = 5;