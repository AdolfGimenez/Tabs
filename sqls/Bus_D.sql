----------bus datos conti
SELECT CASE WHEN COUNT(*) > 100 THEN 'MENSAJES ENCOLADOS :' || COUNT(*) ELSE 'TODO OK :)' END AS STATUS
...
FROM QSYS2.DATA_QUEUE_INFOWHERE DATA_QUEUE_LIBRARY = 'GXFINDTA' AND DATA_QUEUE_NAME = 'AUTSNDDTQ';
SELECT COUNT(*)
